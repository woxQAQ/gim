...
func (x *AuthenticateRequest) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *AuthenticateRequest) GetVerification() string {
	if x != nil {
...
var file_requests_proto_rawDesc = []byte{
	...
	0x12, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x65, 0x0a, 0x13, 0x41, 0x75, 0x74,
	...
	0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x5f, 0x70, 0x62, 0x62, 0x06,
...
var file_requests_proto_goTypes = []interface{}{
	(*AuthenticateRequest)(nil), // 0: message.AuthenticateRequest
}
